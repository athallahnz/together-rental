...
export default function ProductShow({
    ...
    const inventory = product.branch_inventories ?? [];
                    ...
                    <div className="grid content-start gap-6">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Ringkasan read-only; penyesuaian unit
                                    dilakukan pada modul inventaris.
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="grid gap-3">
                                {inventory.length === 0 ? (
                                    <p className="text-sm text-muted-foreground">
                                        Belum ada saldo inventaris cabang.
                                    </p>
                                ) : (
                                    inventory.map((item) => (
                                        <div
                                        ...
                                        >
                                            ...
                                            <p className="mt-2 text-sm">
                                                Stok {item.quantity_on_hand} ·
                                                disewa {item.quantity_rented}
                                            </p>
                                            <p className="mt-1 text-xs text-muted-foreground">
                                                Reservasi{' '}
