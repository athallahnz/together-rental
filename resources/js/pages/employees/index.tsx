...
export default function EmployeeIndex({
    ...
    const toggleEmployeeStatus = async (employee: Employee) => {
        ...
        const confirmed = await confirm({
            title: activating ? stage3Translate('stage3.ui.correction.aktifkan.karyawan.a2548', stage3Locale) : stage3Translate('stage3.ui.correction.nonaktifkan.karyawan.77bdf', stage3Locale),
            description: stage3Translate(
                activating ? 'stage3.ui.correction.confirm.employee.activate' : 'stage3.ui.correction.confirm.employee.deactivate',
                stage3Locale,
                { name: employee.name },
            ),
    ...
    const togglePositionStatus = async (position: Position) => {
        ...
        const confirmed = await confirm({
            title: activating ? stage3Translate('stage3.ui.correction.aktifkan.jabatan.15cb2', stage3Locale) : stage3Translate('stage3.ui.correction.nonaktifkan.jabatan.4df18', stage3Locale),
            description: stage3Translate(
                activating ? 'stage3.ui.correction.confirm.position.activate' : 'stage3.ui.correction.confirm.position.deactivate',
                stage3Locale,
                { name: position.name },
            ),
            confirmLabel: activating ? stage3Translate('stage3.ui.correction.aktifkan.b2fe9', stage3Locale) : stage3Translate('stage3.ui.correction.nonaktifkan.42191', stage3Locale),
    ...
    return (
        <>
            <Head title={stage3Translate('stage3.ui.karyawan.jabatan.1ff53', stage3Locale)} />
            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl p-4 md:p-6">
                <header className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
                    <div>
                        ...
                        <h1 className="mt-1 text-2xl font-semibold tracking-tight">
                            <Stage3Text k="stage3.ui.karyawan.jabatan.1c11a" /></h1>
                        <p className="mt-2 max-w-3xl text-sm leading-6 text-muted-foreground">
                            <Stage3Text k="stage3.ui.kelola.identitas.staf.penempatan.cabang.jabatan.e3940" /></p>
                    </div>
                    {permissions.manage && (
                        <div className="flex flex-wrap gap-2">
                            ...
                            >
                                <BriefcaseBusiness />
                                <Stage3Text k="stage3.ui.tambah.jabatan.508e4" /></Button>
                            <Button onClick={openCreateEmployee}>
                                <Plus />
                                <Stage3Text k="stage3.ui.tambah.karyawan.03c69" /></Button>
                        </div>
                    )}
                </header>
                ...
                {typeof pageErrors.employee === 'string' && (
                    <Alert variant="destructive">
                        <CircleOff />
                        <AlertTitle><Stage3Text k="stage3.ui.perubahan.karyawan.ditolak.c3af9" /></AlertTitle>
                        <AlertDescription>
                            {pageErrors.employee}
                        </AlertDescription>
                    </Alert>
                ...
                {typeof pageErrors.position === 'string' && (
                    <Alert variant="destructive">
                        <CircleOff />
                        <AlertTitle><Stage3Text k="stage3.ui.perubahan.jabatan.ditolak.9fee6" /></AlertTitle>
                        <AlertDescription>
                            {pageErrors.position}
                        </AlertDescription>
                    </Alert>
                ...
                <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                    {[
                        {
                            label: stage3Translate('stage3.ui.correction.total.karyawan.4ebc7', stage3Locale),
                            value: summary.total,
                            icon: ContactRound,
                        },
                        {
                            label: stage3Translate('stage3.ui.correction.karyawan.aktif.acfc1', stage3Locale),
                            value: summary.active,
                            icon: CheckCircle2,
                        },
                        {
                            label: stage3Translate('stage3.ui.correction.belum.punya.akun.c465c', stage3Locale),
                            value: summary.withoutAccount,
                            icon: Link2,
                        },
                        {
                            label: stage3Translate('stage3.ui.correction.sedang.cuti.04b97', stage3Locale),
                ...
                <Card>
                    <CardHeader className="gap-4">
                        <div>
                            <CardTitle><Stage3Text k="stage3.ui.daftar.karyawan.4c6c1" /></CardTitle>
                            <CardDescription>
                                <Stage3Text k="stage3.ui.satu.karyawan.hanya.dapat.dihubungkan.ke.satu.a.f4c1e" /></CardDescription>
                        </div>
                        <div
                        ...
                        >
                            ...
                            >
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        placeholder={stage3Translate('stage3.ui.nama.nomor.telepon.2167f', stage3Locale)}
                                    />
                                </div>
                                <Button
                                    type="submit"
                                    size="icon"
                                    variant="outline"
                                    aria-label={stage3Translate('stage3.ui.cari.karyawan.d36b4', stage3Locale)}
                                >
                                    <Search />
                                </Button>
                            </form>
                            ...
                            >
                                ...
                                <SelectContent>
                                    ...
                                    <SelectItem value="leave"><Stage3Text k="stage3.ui.cuti.7d69c" /></SelectItem>
                                    <SelectItem value="terminated">
                                        <Stage3Text k="stage3.ui.berakhir.6e493" /></SelectItem>
                                </SelectContent>
                            </Select>
                        </div>
                    </CardHeader>
                        ...
                        {employees.data.length === 0 ? (
                            <div className="py-16 text-center">
                                ...
                                <p className="mt-4 font-medium">
                                    <Stage3Text k="stage3.ui.karyawan.tidak.ditemukan.59cd5" /></p>
                                <p className="mt-1 text-sm text-muted-foreground">
                                    <Stage3Text k="stage3.ui.ubah.filter.atau.tambahkan.karyawan.baru.d39ce" /></p>
                            </div>
                        ) : (
                                        ...
                                        <div className="grid gap-2 text-sm">
                                            <p>
                                                {employee.position
                                                    ...
                                                    : stage3Translate('stage3.ui.correction.jabatan.belum.ditentukan.6c7d8', stage3Locale)}
                                            </p>
                                            <p className="text-muted-foreground">
                                                {employee.primary_branch
                                                    ? `${employee.primary_branch.code} · ${employee.primary_branch.name}`
                                                    : stage3Translate('stage3.ui.correction.cabang.utama.belum.ditentukan.ecbfe', stage3Locale)}
                                            </p>
                                            <p className="flex items-center gap-2 text-xs text-muted-foreground">
                                                <UserRoundCheck className="size-4" />
                                                {employee.user
                                                    ? employee.user.email
                                                    : stage3Translate('stage3.ui.correction.belum.terhubung.ke.akun.2dce5', stage3Locale)}
                                            </p>
                                        </div>
                                        {permissions.manage && (
                ...
                <Card>
                    <CardHeader>
                        <CardTitle><Stage3Text k="stage3.ui.master.jabatan.07b9a" /></CardTitle>
                        <CardDescription>
                            <Stage3Text k="stage3.ui.jabatan.nonaktif.tetap.dipertahankan.untuk.menj.f73c6" /></CardDescription>
                    </CardHeader>
                    <CardContent>
                        {positions.length === 0 ? (
                            <p className="py-10 text-center text-sm text-muted-foreground">
                                <Stage3Text k="stage3.ui.belum.ada.data.jabatan.73c48" /></p>
                        ) : (
                                    ...
                                    >
                                        <div className="flex items-start justify-between gap-3">
                                            ...
                                            <Badge variant="secondary">
                                                ...
                                                <Stage3Text k="stage3.ui.karyawan.87c78" /></Badge>
                                        </div>
            ...
            >
                <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-3xl">
                    <DialogHeader>
                        <DialogTitle>
                            {editingEmployee
                                ? stage3Translate('stage3.ui.correction.edit.53016', stage3Locale) + ' ' + editingEmployee.name
                                : stage3Translate('stage3.ui.correction.tambah.karyawan.03c69', stage3Locale)}
                        </DialogTitle>
                        <DialogDescription>
                            <Stage3Text k="stage3.ui.akun.login.bersifat.opsional.dan.dapat.dihubung.07f1f" /></DialogDescription>
                    </DialogHeader>
                    <form onSubmit={submitEmployee} className="grid gap-5">
                        <div className="grid gap-4 sm:grid-cols-2">
                            <FormField
                                label={stage3Translate('stage3.ui.nomor.karyawan.752b5', stage3Locale)}
                            ...
                            <FormField
                                label={stage3Translate('stage3.ui.nama.lengkap.c3587', stage3Locale)}
                                name="name"
                            ...
                            <FormField
                                label={stage3Translate('stage3.ui.cabang.utama.f13ea', stage3Locale)}
                            ...
                            <FormField
                                label={stage3Translate('stage3.ui.jabatan.6cc74', stage3Locale)}
                                name="position_id"
                            ...
                            <FormField
                                label={stage3Translate('stage3.ui.status.bae7d', stage3Locale)}
                                name="status"
                                ...
                                >
                                    ...
                                    <SelectContent>
                                        ...
                                        <SelectItem value="leave">
                                            <Stage3Text k="stage3.ui.cuti.7d69c" /></SelectItem>
                                        <SelectItem value="terminated">
                                            <Stage3Text k="stage3.ui.berakhir.6e493" /></SelectItem>
                                    </SelectContent>
                                </Select>
                            ...
                            <FormField
                                label={stage3Translate('stage3.ui.akun.login.94023', stage3Locale)}
                                name="user_id"
                            ...
                            >
                                ...
                                >
                                    ...
                                    <SelectContent>
                                        <SelectItem value="none">
                                            <Stage3Text k="stage3.ui.tidak.diisi.46951" /></SelectItem>
                                        <SelectItem value="male">
                                            <Stage3Text k="stage3.ui.laki.laki.afdcb" /></SelectItem>
                                        <SelectItem value="female">
                                            <Stage3Text k="stage3.ui.perempuan.bc797" /></SelectItem>
                                    </SelectContent>
                                </Select>
                            </FormField>
                            <FormField
                            ...
                            <FormField
                                label={stage3Translate('stage3.ui.tempat.lahir.c76be', stage3Locale)}
                                name="birth_place"
                            ...
                            <FormField
                                label={stage3Translate('stage3.ui.tanggal.lahir.c7642', stage3Locale)}
                                name="birth_date"
                            ...
                            <FormField
                                label={stage3Translate('stage3.ui.tanggal.bergabung.85a22', stage3Locale)}
                                name="joined_at"
                            ...
                            <FormField
                                label={stage3Translate('stage3.ui.tanggal.berakhir.99021', stage3Locale)}
                                name="ended_at"
                        ...
                        <FormField
                            label={stage3Translate('stage3.ui.alamat.85b6e', stage3Locale)}
                            name="address"
                            ...
                            >
                                {employeeForm.processing
                                    ...
                                    : editingEmployee
                                      ...
                                      : stage3Translate('stage3.ui.correction.buat.karyawan.aee0c', stage3Locale)}
                            </Button>
                        </DialogFooter>
                    </form>
                </DialogContent>
            ...
            >
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle>
                            {editingPosition
                                ? stage3Translate('stage3.ui.correction.edit.53016', stage3Locale) + ' ' + editingPosition.name
                                : stage3Translate('stage3.ui.correction.tambah.jabatan.508e4', stage3Locale)}
                        </DialogTitle>
                        <DialogDescription>
                            <Stage3Text k="stage3.ui.kode.jabatan.unik.dalam.perusahaan.dan.dipakai.081ca" /></DialogDescription>
                    </DialogHeader>
                    <form onSubmit={submitPosition} className="grid gap-4">
                        <FormField
                            label={stage3Translate('stage3.ui.kode.jabatan.0e67b', stage3Locale)}
                            name="position_code"
                        ...
                        <FormField
                            label={stage3Translate('stage3.ui.nama.jabatan.be836', stage3Locale)}
                            name="position_name"
                        ...
                        <label className="flex items-start gap-3 rounded-lg border p-4">
                            ...
                            <span>
                                <span className="block text-sm font-medium">
                                    <Stage3Text k="stage3.ui.jabatan.aktif.f91b7" /></span>
                                <span className="mt-1 block text-xs text-muted-foreground">
                                    <Stage3Text k="stage3.ui.dapat.dipilih.untuk.karyawan.baru.4800a" /></span>
                            </span>
                        </label>
                        <DialogFooter>
                            <Button
                            ...
                            >
                                {positionForm.processing
                                    ...
                                    : editingPosition
                                      ? stage3Translate('stage3.ui.correction.simpan.perubahan.099b3', stage3Locale)
                                      : stage3Translate('stage3.ui.correction.buat.jabatan.5df05', stage3Locale)}
                            </Button>
                        </DialogFooter>
                    </form>
                </DialogContent>
