...
class UpdateProductPublicContentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'short_description_en' => ['sometimes', 'nullable', 'string', 'max:320'],
            'description' => ['sometimes', 'nullable', 'string', 'max:3000'],
            'description_en' => ['sometimes', 'nullable', 'string', 'max:3000'],
            'seo_title_en' => ['sometimes', 'nullable', 'string', 'max:180'],
            'seo_description_en' => ['sometimes', 'nullable', 'string', 'max:320'],
